...
import (
	...
	internalinterfaces "github.com/Mathew857/democrd/pkg/client/informers/externalversions/internalinterfaces"
	v1 "github.com/Mathew857/democrd/pkg/client/listers/democrd/v1"
...
func (f *mydemoInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&democrdv1.Mydemo{}, f.defaultInformer)
}
